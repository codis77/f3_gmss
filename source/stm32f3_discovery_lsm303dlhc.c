...
/** STM32F3_DISCOVERY_LSM303DLHC_Private_FunctionPrototypes
  */
...
void  LSM303DLHC_AccInit (LSM303DLHCAcc_InitTypeDef *LSM303DLHC_InitStruct)
{
  ...
  ctrl4 |= (uint8_t) (LSM303DLHC_InitStruct->BlockData_Update | LSM303DLHC_InitStruct->Endianness | LSM303DLHC_InitStruct->AccFull_Scale|LSM303DLHC_InitStruct->High_Resolution);
